...
class Settings(BaseSettings):
    ...
    # Sprint 5.6 — customer phone OTP via Twilio SMS. Empty values keep it
    # disabled (client no-ops, like resend) so dev/CI run without credentials;
    # activate by setting all three.
