...
export function GoogleReviewButton({ url, tenantSlug, accentColor }: Props) {
  ...
  return (
    <a
      ...
      className="group flex w-full flex-col items-center justify-center gap-1 rounded-xl px-6 py-5 text-center font-semibold shadow-[0_8px_24px_rgba(0,0,0,0.5)] ring-1 ring-white/15 transition-transform active:scale-[0.98] sm:py-6"
